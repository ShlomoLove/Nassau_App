...
const newData = [ {
    _id: 1,
    breadcrumbs: ['HOME', 'MEN', 'SWEATERS', 'MILANO RIBBED RELAXED CREW NECK SWEATER'],
  ...
  { 
    _id: 2,
    breadcrumbs: ['HOME', 'MEN', 'DRESS SHIRTS', 'MEN SUPER NON-IRON SLIM-FIT LONG-SLEEVE SHIRT'],
    name: 'MEN SUPER NON-IRON SLIM-FIT LONG-SLEEVE SHIRT',
    sku: '411829',
    stars: 5,
    reviews: 6,
    price: '29.90',
    colorNames: ['01 CREAM', '08 RED', '09 GRAY'],
  ...
  { 
    _id: 3,
    breadcrumbs: ['HOME', 'MEN', 'JACKETS', 'MEN ULTRA LIGHT DOWN JACKET'],
    name: 'MEN ULTRA LIGHT DOWN JACKET',
    sku: '400504',
    stars: 4.25,
    reviews: 142, 
    price: '69.90',
    colorNames: ['01 OFF WHITE', '54 GREEN', '34 RED', '09 DARK GRAY', '62 LIGHT BLUE', '72 SLATE'],
  ...
  { 
    _id: 4,
    breadcrumbs: ['HOME', 'WOMEN', 'DRESSES', 'WOMEN U DRAWSTRING LONG-SLEEVE DRESS'],
    name: 'WOMEN U DRAWSTRING LONG-SLEEVE DRESS',
    sku: '415814',
    stars: 0,
    reviews: 0,
    price: '39.90',
    colorNames: ['03 CREAM', '25 SKY BLUE', '34 LIGHT PINK'], 
  ...
  { 
    _id: 5,
    breadcrumbs: ['HOME', 'MEN', 'JEANS', 'MEN STRETCH SELVEDGE SLIM-FIT JEANS'],
    name: 'MEN STRETCH SELVEDGE SLIM-FIT JEANS',
    sku: '413154',
    stars: 4.5,
    reviews: 5,
    price: '49.90',
    colorNames: ['01 BEIGE', '71 NAVY BLUE', '09 BLACK'],
  ...
  { 
    _id: 6,
    breadcrumbs: ['HOME', 'WOMEN', 'SHIRTS', 'WOMEN PREMIUM LINEN LONG-SLEEVE SHIRT'],
    name: 'WOMEN PREMIUM LINEN LONG-SLEEVE SHIRT',
    sku: '414169',
    stars: 0,
    reviews: 0,
    price: '29.90',
    colorNames: ['00 WHITE', '03 CREAM', '06 GRAY', '09 BLACK', '15 BLUE', '19 RED', '23 GREEN', '45 TEAL', '42 DODGER BLUE', '73 SKY BLUE'],
  ...
  { 
    _id: 7,
    breadcrumbs: ['HOME', 'WOMEN', 'SHIRTS', 'WOMEN EXTRA FINE COTTON STAND COLLAR LONG-SLEEVE SHIRT'],
    name: 'WOMEN EXTRA FINE COTTON STAND COLLAR LONG-SLEEVE SHIRT',
    sku: 414163,
    stars: 0,
    reviews: 0,
    price: '29.90',
    colorNames: ['00 WHITE', '32 YELLOW', '43 RED'],
  ...
  { 
    _id: 8,
    breadcrumbs: ['HOME', 'MEN', 'SHIRTS', 'MEN U CREW NECK SHORT-SLEEVE T-SHIRT'],
    name: 'MEN U CREW NECK SHORT-SLEEVE T-SHIRT',
    sku: '409642',
    stars: 5,
    reviews: 19,
    price: '14.90',
    colorNames: ['00 WHITE', '14 GRAY', '18 GREEN', '31 ORANGE', '42 DODGER BLUE'],
  ...
  { 
    _id: 9,
    breadcrumbs: ['HOME', 'WOMEN', 'SHIRTS AND BLOUSES', 'WOMEN RAYON LONG-SLEEVE BLOUSE'],
    name: 'WOMEN RAYON LONG-SLEEVE BLOUSE',
    sku: '414138',
    stars: 4,
    reviews: 16,
    price: '29.90',
    colorNames: ['00 WHITE', '09 BLACK', '10 PINK', '20 ORANGE', '57 OLIVE', '60 LIGHT BLUE', '69 NAVY'],
    colors: ['aeafa9', '5f696a', '343436', 'cc2a37', '265b63', '363d47', '764b45'],
    sizes: ['XXS','XS', 'S', 'M', 'L', 'XL'], 
    details: ['Designed with opaque material, our rayon blouse has stunning new details.', 'Special processing keeps it wrinkle-resistant even after washing.', 'Updated for a new season with a wider body and a shorter hem.', 'Updated box-pleat at back.', 'Collar redesigned to a sharper look.', 'Slightly thicker interfacing showcases the shape of the collar and cuffs.', 'New opaque material offers the same smoothness as before with easier layering, even in light colors.'], 
    material: '76% Rayon, 24% Polyester', 
    care: 'Machine wash cold, gentle cycle', 
    pictures: ['https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_09.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_1.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_2.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_3.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_4.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_5.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_69.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414458_7.jpeg']
  },
  { 
    _id: 9,
    breadcrumbs: ['HOME', 'WOMEN', 'SHIRTS AND BLOUSES', 'WOMEN DRAPE 3/4 SLEEVE BLOUSE'],
    name: 'WOMEN DRAPE 3/4 SLEEVE BLOUSE',
    sku: '414144',
    stars: 4.75,
    reviews: 8,
    price: '29.90',
    colorNames: ['01 OFF WHITE', '30 NATURAL', '54 GREEN', '69 NAVY'],
    colors: ['e8e9ea', '1f3241', 'ccb49c', '2e3041'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'], 
    details: ['Designed with Updated details create a neater collar and cuffs. Our stylish and feminine blouse. material, our rayon blouse has stunning new details.', 'Wrinkle-resistant even after washing for easy care.', 'Updated for a new season! Updated shoulder design keeps the cuffs neat.', 'Redesigned opening in the back and a thicker feel help the neckline stay put'], 
    material: '76% Rayon, 24% Polyester', 
    care: 'Machine wash cold, gentle cycle', 
    pictures: ['https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_00.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_05.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_1.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_11.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_12.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_14.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_2.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_3.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_4.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_5.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_52.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_6.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_61.jpeg', 'https://s3-us-west-1.amazonaws.com/ouiqlndetailsimage/goods_414578_69.jpeg']
  },
]
